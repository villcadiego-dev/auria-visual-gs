...
// SIN CUBOS - Truck scene no necesita cubos interactivos
...
// Configuración de la escena truck desde scene-configs.js
const sceneName = 'truck';
...
viewer.addSplatScene(sceneConfig.splatPath, loadOptions)
    .then(() => {
        ...
        // SIN CAJAS FÍSICAS - Truck scene mantiene espacio limpio
        ...
        // SIN SISTEMA DE INTERACCIÓN - Truck scene sin objetos interactivos
    })
    .catch((error) => {
...
function setupRotationControls() {
    ...
    function updateTransform() {
        ...
        // Alternativa: También intentar marcar como necesita actualización
        if (splatScene.updateTransform) {
            splatScene.updateTransform(viewer.dynamicScene);
        }
