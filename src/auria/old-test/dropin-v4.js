...
viewer.addSplatScene('/assets/data/garden/garden_high.ksplat', {
        // Empezar sin rotación para que los controles empiecen desde cero
        rotation: [0, 0, 0, 1], // Quaternion identidad - sin rotación inicial
    })
    .then(() => {
        viewer.start();
...
// Función para configurar los controles de rotación en tiempo real
function setupRotationControls() {
    ...
    // Variables para mantener los valores de rotación actuales
    let currentRotX = 0;
    let currentRotY = 0;
    let currentRotZ = 0;
    ...
    function updateRotation() {
        ...
        // Actualizar display del quaternion
    ...
    console.log('🔄 Controles de rotación configurados - usa los sliders para rotar el Gaussian splat');
}